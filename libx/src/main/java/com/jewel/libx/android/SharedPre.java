...
public class SharedPre {
    private static final String TAG = SharedPre.class.getSimpleName();

    @SuppressLint("StaticFieldLeak")
    private static final SharedPre Instance = new SharedPre();
     ...
     */
    public static synchronized SharedPre init(Context context, String sharedPrefsName) {
        // Defensive checks
     ...
     */
    private static SharedPre getInstance() {
        if (!Instance.mWasInitialized) {
            throw new RuntimeException(
     ...
     */
    private <T> SharedPre saveAsync(final String key, final T value, final Callback callback) {
        // Put it in memory
        mData.put(key, value);

        // Save it to disk
        SaveAsyTask task = new SaveAsyTask(this, key, value, callback);
     ...
     */
    public static SharedPre putFloat(final String key, final float value) {
     ...
     */
    public static SharedPre putInt(String key, int value) {
        return getInstance().saveAsync(key, value, null);
    }
     ...
     */
    public static SharedPre putLong(String key, long value) {
        return getInstance().saveAsync(key, value, null);
    }
     ...
     */
    public static SharedPre putString(String key, String value) {
        return getInstance().saveAsync(key, value, null);
    }
     ...
     */
    public static SharedPre putBoolean(String key, boolean value) {
        return getInstance().saveAsync(key, value, null);
    }
     ...
     *                 and will be passed 'true' if successful, 'false' if not.
     */
    public static SharedPre putFloat(final String key, final float value, final Callback callback) {
     ...
     *                 and will be passed 'true' if successful, 'false' if not.
     */
    public static SharedPre putInt(String key, int value, final Callback callback) {
        return getInstance().saveAsync(key, value, callback);
    }
     ...
     *                 and will be passed 'true' if successful, 'false' if not.
     */
    public static SharedPre putLong(String key, long value, final Callback callback) {
        return getInstance().saveAsync(key, value, callback);
    }
     ...
     *                 and will be passed 'true' if successful, 'false' if not.
     */
    public static SharedPre putString(String key, String value, final Callback callback) {
        return getInstance().saveAsync(key, value, callback);
    }
     ...
     *                 and will be passed 'true' if successful, 'false' if not.
     */
    public static SharedPre putBoolean(String key, boolean value, final Callback callback) {
        return getInstance().saveAsync(key, value, callback);
    }
    ...
    // Save it to disk
    private static class SaveAsyTask extends AsyncTask<Void, Void, Boolean> {
        ...
        public SaveAsyTask(SharedPre sharedPre, String key, Object value, Callback callback) {
        ...
        protected Boolean doInBackground(Void... params) {
            return sharedPre.saveToDisk(key, value);
        }
